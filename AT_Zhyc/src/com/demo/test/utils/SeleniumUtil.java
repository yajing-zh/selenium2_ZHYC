...
public class SeleniumUtil {
	...
	public void launchBrowser(String browserName, ITestContext context,
			String webUrl, int timeOut, boolean loginAutomaticly) {
	...
	public void clear(By byElement) {
		try {
			// // 获得cookie的第一种方法：直接通过cookie名称来获取
			// driver.findElement(byElement).click();
			// System.out
			// .println("name=" + driver.manage().getCookieNamed("name"));
			// // 第二种方法：
			...
			// System.out.println("作用域：" + cookie.getDomain() + ", 名称："
			// + cookie.getName() + ", 值：" + cookie.getValue()
			// + ", 范围：" + cookie.getPath() + ", 过期时间"
			// + cookie.getExpiry());
